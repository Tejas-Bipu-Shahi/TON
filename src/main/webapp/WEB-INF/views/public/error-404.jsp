...
<head>
    ...
    <title>Page Not Found — Thoughts of Nomads</title>
...
<body class="page-layout">
    ...
    <main class="error-main">
        <div class="error-card">
            ...
            <p class="error-desc">
                This destination doesn't exist on our map. The page may have been moved, deleted, or the link might be incorrect.
            </p>
            <div class="btn-row">
                ...
                <a href="<%= request.getContextPath() %>/latest" class="btn-ghost">
